...
static int novatek_lgd_on(struct novatek_lgd *ctx)
{
	...
	dsi_dcs_write_seq(dsi, 0x92, 0x94);
	dsi_dcs_write_seq(dsi, 0xff, 0xe0);
	dsi_dcs_write_seq(dsi, 0xfb, 0x01);
	dsi_dcs_write_seq(dsi, 0xb8, 0xad);
	dsi_dcs_write_seq(dsi, 0xb5, 0x86);
	dsi_dcs_write_seq(dsi, 0xb6, 0x77);
	dsi_dcs_write_seq(dsi, 0xff, 0xe0);
	dsi_dcs_write_seq(dsi, 0xfb, 0x01);
...
static int novatek_lgd_remove(struct mipi_dsi_device *dsi)
{
